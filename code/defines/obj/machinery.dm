...
/obj/machinery/dye_mixer
	name = "Dye mixer"
	desc = "A high-tech dye mixer."
	icon = 'vending.dmi'
	icon_state = "generic"
	anchored = 1
	density = 1
...
/obj/machinery/vending/chemi
	name = "Chemistry Vender"
	desc = "A vending machine for chemical supplys."
	icon_state = "generic"
	product_slogans = "Get your grenades here!;Twice the damage for half the price!"
	product_paths = "/obj/item/weapon/chem_grenade;/obj/item/device/igniter;/obj/item/device/timer"
	product_amounts = "20;20;20"
	vend_delay = 34
	product_hidden = "/obj/item/assembly/time_ignite"

/obj/machinery/vending/mining
	name = "Mining Vender"
	desc = "A vending machine for mining supplys."
	icon_state = "generic"
	product_slogans = "Twice the rocks for half the price!"
	product_paths = "/obj/item/weapon/pickaxe;/obj/item/device/mars/navigation/pointer"
	product_amounts = "10;5"
	vend_delay = 34
	product_hidden = "/obj/item/weapon/chunk"
