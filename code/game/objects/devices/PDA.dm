...
/obj/item/weapon/integrated_uplink/proc/generate_menu()
	...
	src.menu_message += "<HR>"
	src.menu_message += "<b>[src.hostpda.job] related traitor items:</b><BR>"
	switch(src.hostpda.job)
		if("Captain")
			src.menu_message += "We can not offer you any traitor items for your job. We are sorry."
		if("Head of Personell")
			src.menu_message += "We can not offer you any traitor items for your job. We are sorry."
		if("Head of Security")
			src.menu_message += "We can not offer you any traitor items for your job. We are sorry."
		if("Chief Engineer")
		...
		if("Quartermaster")
			src.menu_message += "We can not offer you any traitor items for your job. We are sorry."
		if("Barber")
			src.menu_message += "<A href='byond://?src=\ref[src];buy_item=sharpener'>Sharpening Stone</A> (4)<BR>"
		if("Mailman")
			src.menu_message += "We can not offer you any traitor items for your job. We are sorry."
		if("Assistant")
			src.menu_message += "We can not offer you any traitor items for your job. We are sorry."
	...
	if (href_list["buy_item"])
		switch(href_list["buy_item"])
			...
			if("sharpener")
				if (src.uses >= 4)
				 src.uses -= 4
				 new /obj/item/weapon/jobitems/sharpening(get_turf(src.hostpda))
		src.generate_menu()
		src.print_to_host(src.menu_message)
		return
