...
/mob/living/carbon/human/proc/Equip_Rank(rank, joined_late)
	...
	*/
	...
	switch(rank)
		...
		if ("Miner")
			src.equip_if_possible(new /obj/item/clothing/under/mining/miner(src), slot_w_uniform)
			src.equip_if_possible(new /obj/item/clothing/shoes/black(src), slot_shoes)
			src.equip_if_possible(new /obj/item/weapon/pickaxe(src), slot_l_hand)
		...
		if ("Tourist")
			src.equip_if_possible(new /obj/item/clothing/under/rank/tourist(src), slot_w_uniform)
			src.equip_if_possible(new /obj/item/clothing/shoes/sandal(src), slot_shoes)
			src.equip_if_possible(new /obj/item/weapon/camera_test(src), slot_in_backpack)

		if ("Mailman")
			src.equip_if_possible(new /obj/item/clothing/under/color/blue(src), slot_w_uniform)
			src.equip_if_possible(new /obj/item/clothing/shoes/black(src), slot_shoes)
			src.equip_if_possible(new /obj/item/clothing/head/mail(src), slot_head)
...
/mob/living/carbon/human/proc/spawnId(rank)
	...
	switch(rank)
		// CRAPTAINS, EH CAPTAINS
		if("Captain")
			C = new /obj/item/weapon/card/id/gold(src)
		// MEDICAL GUYS / SCIENCE GUYS
		if("Geneticist")
			C = new /obj/item/weapon/card/id/medi(src)
		if("Chemist")
			C = new /obj/item/weapon/card/id/medi(src)
		if("Medical Doctor")
			C = new /obj/item/weapon/card/id/medi(src)
		...
		if("Research Director")
			C = new /obj/item/weapon/card/id/medi(src)
		// RELASE THE SINGULARITY
		if("Station Engineer")
			C = new /obj/item/weapon/card/id/engin(src)
		if("Miner")
			C = new /obj/item/weapon/card/id/engin(src)
		if("Quartermaster")
			C = new /obj/item/weapon/card/id/engin(src)
		...
		// .. ARREST CRIMINALS?
		if("Detective")
			C = new /obj/item/weapon/card/id/secu(src)
		if("Security Officer")
			C = new /obj/item/weapon/card/id/secu(src)
		if("Head of Security")
			C = new /obj/item/weapon/card/id/secu(src)
		if("O.W.L.S. Commander")
			C = new /obj/item/weapon/card/id/secu(src)
		if("O.W.L.S. Officer")
			C = new /obj/item/weapon/card/id/secu(src)
		else
