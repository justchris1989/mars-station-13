...
/obj/item/weapon/reagent_containers/food/drinks/glas
	name = "drinking glass"
	desc = "You can fill it with liquids."
	icon = 'kitchen.dmi'
	icon_state = "glass_empty"

/obj/item/weapon/reagent_containers/food/drinks/vodka
	name = "Vodka"
	desc = "The label reads 'Russian's best'"
	icon_state = "vodka"
	heal_amt = 1
	New()
		var/datum/reagents/R = new/datum/reagents(50)
...
/obj/item/weapon/reagent_containers/food/drinks/reserve
	name = "Scotty's private reserve"
	desc = "Wow. It's probably strong enough to get the detective drunk."
	icon_state = "reserve"
	heal_amt = 1
	New()
		var/datum/reagents/R = new/datum/reagents(50)
